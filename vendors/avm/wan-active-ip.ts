// canonical.interface.wan.ip_address on a FRITZ!Box, whichever WAN
...
//
// One script, one output: canonical.interface.wan.uptime has its own
...
var LEAF = "ExternalIPAddress";
var OUTPUT = "canonical.interface.wan.ip_address";
